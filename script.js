...
inputX, inputY, lengthX, lengthY, sumX, sumY, meanX, meanY, inputXMinusMeanX, inputYMinusMeanY, 
inputXYMinusMeanXY, sumInputXYMinusMeanXY, cov;
...
function calculating() {
    ...
    //calculating cov
    cov = sumInputXYMinusMeanXY / (lengthX - 1);
};
...
function showResult() {
    ...
    document.getElementById("cov-big").innerHTML = cov;
